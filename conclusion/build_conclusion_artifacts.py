    ...
    write_json(
        CONFIGS_DIR / "FD001" / "fd001_best_model_config.json",
        {
            ...
            "artifacts": {
                ...
                "explicit_final_predictions": str(PREDICTIONS_DIR / "fd001_final_quantile_best_model_predictions.csv"),
                "official_test_metrics": str(out_dir / "fd001_official_test_metrics.csv"),
                "explicit_final_metrics": str(out_dir / "fd001_final_quantile_official_test_metrics.csv"),
            },
        },
    )
